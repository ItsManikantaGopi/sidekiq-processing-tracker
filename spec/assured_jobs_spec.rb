...
RSpec.describe Sidekiq::AssuredJobs do
  ...
  describe ".configure" do
    it "sets up default configuration" do
      ...
      expect(described_class.namespace).to eq("sidekiq_assured_jobs")
    ...
    it "respects environment variables" do
      ...
      ENV["ASSURED_JOBS_NS"] = "test_namespace"
      ENV["ASSURED_JOBS_HEARTBEAT_INTERVAL"] = "5"
      ...
      # Clean up
      ENV.delete("ASSURED_JOBS_NS")
      ENV.delete("ASSURED_JOBS_HEARTBEAT_INTERVAL")
    end
  end
